...
import { ProfileStats as ProfileStatsType } from '@/lib/api/profiles'
import { BarChart, Activity, Users, MessageSquare, Send } from 'lucide-react'
...
export const ProfileStats: React.FC<ProfileStatsProps> = ({ stats, isLoading }) => {
  if (isLoading) {
    return (
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {stats.total_campaigns} total campaigns
          </p>
        </CardContent>
      </Card>
